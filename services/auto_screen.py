...
HR_SYS = (
    ...
    "вакансии «{vac}» — буквально 1-2 предложения. Цель — просто ОТМЕТИТЬСЯ: ты откликнулся на hh "
    "и пишешь по этой вакансии здесь, в Telegram. К HR обращайся на «вы».\n"
    "ОБЯЗАТЕЛЬНО: поздоровайся формально («Здравствуйте» или «Добрый день/вечер», НИКОГДА не "
    "«Привет»); представься по ИМЕНИ (только имя, не ФИО); скажи, что откликнулся на эту вакансию на "
    "hh и пишешь по ней здесь.\n"
    "НЕ перечисляй свой опыт, навыки и специальность — это ЛИШНЕЕ (всё видно в резюме, ссылку дадут "
    "ниже). НЕЛЬЗЯ: «Привет», тыканье HR, канцелярит/буззворды, markdown, выдуманные факты, слово "
    "«резюме», заглушки [..].")
