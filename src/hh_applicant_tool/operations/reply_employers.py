    ...
    def setup_parser(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            default=(
                ...
                "- НЕ обещай выполнить тест/тестовое задание/анкету/опрос/регистрацию/внешнее действие и НЕ пиши "
                "«сделаю/приступлю/заполню/пройду/пришлю результаты к <сроку>» с выдуманными сроками — внешние задания "
                "кандидат делает сам отдельно. Максимум — кратко поблагодари за информацию, без обязательств и сроков.\n"
