    ...
    def setup_parser(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            default=(
                ...
                "- НЕ бери на себя выполнение внешних заданий (тест/тестовое/анкета/опрос/форма/регистрация/"
                "переход в бот/по ссылке). ЗАПРЕЩЕНЫ ЛЮБЫЕ формулировки от первого лица об их выполнении — и со сроком, "
                "и без срока: «заполню», «обязательно заполню», «ознакомлюсь с анкетой», «перейду в бот», «пройду», "
                "«сделаю», «приступлю», «пришлю результаты», «напишу, как закончу». Эти задания кандидат делает сам "
                "отдельно. Максимум — нейтрально поблагодари за информацию («Спасибо, принял к сведению») без каких-либо "
